...
description: The sustained translation edge, in which two systems that will not change each talk
---
...
counterpart's portal, and each keeps talking its own protocol; the
...
protocol, and the identity matches across bindings (the delimited GS1
